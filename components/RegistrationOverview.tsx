    ...
    return <section className='w-full px-6 py-8 flex flex-col items-center justify-center'>
        <div className="flex flex-1 flex-col gap-6 max-w-4xl items-center text-center">
            ...
            <h2 className="text-xl md:text-xl text-white leading-relaxed">
                You now have access to our competitor portal are eligible to be registered on teams to compete in our <b>2026</b> event. Here you can <b>view and update your account details</b> and view your <b>registration requests status.</b> 
            </h2>
