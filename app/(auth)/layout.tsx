...
const Layout = ({ children }: {children: ReactNode}) => {
  return (
    <main className="flex min-h-screen w-full flex-col md:flex-row-reverse">
      ...
      <section className="relative h-[30vh] w-full md:h-screen md:w-1/2">
        <Image 
          src="/images/2025_WFS.jpg" 
          alt="Auth Image" 
          fill 
      ...
      <section className="relative flex flex-1 flex-col items-center justify-center px-4 py-10 md:w-1/2 md:px-20">
        ...
        <div className="flex w-full max-w-[420px] flex-col items-center justify-center gap-6 text-center
         bg-white/5 backdrop-blur-sm p-8 rounded-2xl shadow-2xl text-white border border-transparent hover:border-white/20 transition-colors duration-50">
